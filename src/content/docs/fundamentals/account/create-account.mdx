...
title: cara aktivasi Token BNI direct terkunci
sidebar:
  order: 1
head: []
description: Membuka blokir BNIdirect yang terkunci (User ID atau Mobile Token) paling cepat dilakukan dengan DM BNI Call Center di 1500046, WA resmi BNI O82I>626>6664 atau melalui Relationship Manager (RM). Siapkan dokumen perusahaan seperti Company ID, User ID, dan NIK. Cloudflare account.
products:
  - fundamentals
---
